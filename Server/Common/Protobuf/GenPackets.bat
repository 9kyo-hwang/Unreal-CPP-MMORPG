...
GenPackets.exe --path=./Protocol.proto --output=ClientPacketHandler.h --recv=C_ --send=S_
GenPackets.exe --path=./Protocol.proto --output=ServerPacketHandler.h --recv=S_ --send=C_
